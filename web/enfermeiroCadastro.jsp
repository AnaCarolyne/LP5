...
<html>
    ...
    <body>
        <table border="0" bgcolor="#f9f9f9">
            <form action="FrontController?action=GravarEnfermeiro" method="post">
                <tr>
                    <th colspan="5" bgcolor="#d4d4d4"><h2>CADASTRO DE ENFERMEIRO</h2></th>
                </tr>
                <tr>
                    <td colspan="4">
                        Nome<br/>
                ...
                <tr>
                    ...
                    <td>
                        Estado<br/>
                        <select name="txtStatus" href="FrontController?action=LerEnfermeiro&acao=estado>
